...
final class DifferentialReviewersAddRoundRobinReviewersNonBlockingHeraldAction
  extends DifferentialReviewersHeraldAction {

  const ACTIONCONST = 'differential.round.robin.nonblocking.reviewers.add';

  public function getHeraldActionName() {
    return pht('Add a non-blocking reviewer in the Round-Robin way');
  }
  ...
  public function applyEffect($object, HeraldEffect $effect) {
    ...
    $api_token = "xxxxxxxxxxxxxxxxxxxxxx"; #you need to put a api token here 
    ...
    $new_phids[] = $phid;
    return $this->applyReviewers($new_phids, $is_blocking = false);
  }
  ...
  public function getOneMember($rule_ID, $project, $member_phids_latest){
    ...
    $keys = array();
    $key = $project . $rule_ID . '_nb_rr_string';
    $keys[] = $key;
  ...
  public function renderActionDescription($value) {
    return pht('Add a non-blocking reviewer in the Round-Robin way: %s.', $this->renderHandleList($value));
  }
